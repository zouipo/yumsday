...
func setUpDataTestItem() *MockItemRepository {
	...
	mockRepo.items = append(mockRepo.items, model.Item{
		ID:                 2,
		Name:               "Rice",
		Description:        utils.Ptr("White rice"),
	...
	mockRepo.items = append(mockRepo.items, model.Item{
		ID:                 6,
		Name:               "Soft drinks",
		Description:        utils.Ptr("Beverage with no alcohol, usually carbonated"),
...
func TestCreateItem(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			item: &model.Item{
				Name:               "Pasta",
				Description:        utils.Ptr("Dry spaghetti"),
				AverageMarketPrice: utils.Ptr(2.10),
				UnitType:           enum.Weight,
		...
		},
		{
			...
			item: &model.Item{
				...
				Description:        utils.Ptr("Carbonated water"),
				AverageMarketPrice: utils.Ptr(1.30),
				UnitType:           enum.Volume,
				GroupID:            group1.ID,
				ItemCategory:       model.ItemCategory{},
			},
	...
	tests := []struct {
	...
	}{
		{
			...
			item: &model.Item{
				ID:                 1,
				Name:               "Flour Premium",
				Description:        utils.Ptr("Premium all-purpose flour"),
				AverageMarketPrice: utils.Ptr(3.20),
				UnitType:           enum.Weight,
				GroupID:            itemCategory1.GroupID,
				ItemCategory:       itemCategory1,
			},
